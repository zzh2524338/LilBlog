package com.LilChou.ssm.blog.controller.admin;

import com.LilChou.ssm.blog.entity.Page;
import com.LilChou.ssm.blog.enums.PageStatus;
import com.LilChou.ssm.blog.service.PageService;
...
public class    BackPageController {
    ...
    public ModelAndView insertPageSubmit(Page page) {
        ...
        if (checkPage == null) {
            ...
            mvc.setViewName("redirect:/admin/page");
        }else{
            mvc.addObject("msg", "已存在该别名");
            mvc.setViewName("Admin/Page/insert");
        }
        return mvc;
    }
    ...
    public ModelAndView editPageSubmit(Page page) {
        Page checkPage = pageService.getPageByKey(null, page.getPageKey());
        //判断别名是否存在且不是这篇文章
        if (checkPage == null || Objects.equals(checkPage.getPageId(), page.getPageId())){
            ...
            ModelAndView mvc = new ModelAndView();
            mvc.addObject("message", "重复别名");
            mvc.setViewName("Admin/Page/edit");
            return mvc;
        }
